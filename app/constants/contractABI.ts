export const CONTRACT_ABI = [
  ...
  },
  {
    inputs: [],
    name: "CroFamToken",
    outputs: [{ internalType: "contract ICROFAM", name: "", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_croPrice", type: "uint256" },
      { internalType: "uint256", name: "_croWlPrice", type: "uint256" },
      { internalType: "uint256", name: "_croFamPrice", type: "uint256" },
      { internalType: "uint256", name: "_croFamWlPrice", type: "uint256" },
    ],
    name: "setAllPrices",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "bool", name: "isOnPause", type: "bool" }],
    name: "setPause",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
